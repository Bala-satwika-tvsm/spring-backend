...
class CallRecordingsServiceTest {
    ...
    @BeforeEach
    void setUp() {
        CallRecordingsEntity record1 = new CallRecordingsEntity("9876543210", "1787867786.5334", "50", "ANSWERED", "25-03-2025", "http://example.com/record1.mp3");
        CallRecordingsEntity record2 = new CallRecordingsEntity("8765432109", "1787867786.5378", "11", "MISSED", "22-07-2024", "http://example.com/record2.mp3");
